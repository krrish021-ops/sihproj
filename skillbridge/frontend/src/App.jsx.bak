  ...
  return (
    <Routes>
      ...
      <Route path="/student/assessment" element={
        <ProtectedRoute role="student"><AssessmentPage /></ProtectedRoute>
      } />
      <Route path="/student/profile" element={
        <ProtectedRoute role="student"><ProfilePage /></ProtectedRoute>
      } />
      <Route path="/student/recommendations" element={
        <ProtectedRoute role="student"><RecommendationsPage /></ProtectedRoute>
      } />

      <Route path="/recruiter/dashboard" element={
        <ProtectedRoute role="recruiter"><RecruiterDashboard /></ProtectedRoute>
      } />
      <Route path="/recruiter/post-opportunity" element={
        <ProtectedRoute role="recruiter"><PostOpportunityPage /></ProtectedRoute>
      } />
      <Route path="/recruiter/candidates/:id" element={
        <ProtectedRoute role="recruiter"><CandidateRecommendationsPage /></ProtectedRoute>
      } />

      <Route path="/academician/dashboard" element={
        <ProtectedRoute role="academician"><AcademicianDashboard /></ProtectedRoute>
      } />
    </Routes>
  )
}
